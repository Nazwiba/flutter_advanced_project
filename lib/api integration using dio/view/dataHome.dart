...
import 'package:flutter_advanced_project/api%20integration%20using%20dio/controller/dataController.dart';
import 'package:flutter_advanced_project/api%20integration%20using%20dio/utils/colors.dart';
import 'package:flutter_advanced_project/api%20integration%20using%20dio/utils/const_snackbar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => SizedBox(
          ...
          // obx vechu kokdumbol aa oru widget mathre rebuild aavollu set state vechu kokdumbol entire widget tree rebuild aavum
          ),
    );
  }
  ...
  RefreshIndicator getData() {
    return RefreshIndicator(
      ...
      child: ScrollablePositionedList.builder(
          itemScrollController: controller.scrollConroller,
